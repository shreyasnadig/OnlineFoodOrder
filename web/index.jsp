<%-- 
    Document   : index
    Created on : Jul 26, 2016, 7:26:12 PM
    Author     : DELL
--%>
...
<body >
    <%@include file="nav.jsp" %>
			...
			<div class="service-section-top-row">
				<div class="container">
					<div class="service-section-top-row-grids wow" data-wow-delay="0s">
					<div class="col-md-2 service-section-top-row-grid1">
						<h3>Enjoy Exclusive Food</h3>
					</div>
